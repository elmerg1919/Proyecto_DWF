...
<body>
	...
	<div class="row alert alert-info">
		<div class="container">
			<h2>
				<strong>Ofertas pendientes </strong><a class="btn btn-success" href="${contextPath}/empresa.do?op=nuevao"><i
										class="fas fa-plus"></i> Nueva oferta</a>
			</h2>
			<p class="help-block">
						...
						<c:forEach items="${requestScope.listaOfertasPendientes}"
							...
							<tr>
								...
								<td><a style="width: 100%" class="btn btn-primary"
									href="${contextPath}/empresa.do?op=obtenero&id=${ofertasPendientes.codigo}"><i
					...
					<tbody>
						...
						<c:forEach items="${requestScope.listaOfertas}"
							...
							<tr>
								...
								<td><a style="width: 100%" class="btn btn-primary"
									href="${contextPath}/empresa.do?op=obtenero&id=${ofertas.codigo}"><i
										class="fas fa-search"></i></a></td>
