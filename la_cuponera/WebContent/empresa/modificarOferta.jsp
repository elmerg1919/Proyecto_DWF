...
<body>
	...
	<div class="container col-xs-10 col-sm-8 col-md-6">
		<div class="row">
			...
			<form action="${contextPath}/empresa.do?op=modificaro&id=<%=sesion.getAttribute("codigoEmpresa")%>&of=${oferta.codigo}" method="POST">
				<input type="hidden" name="op" value="modificaro">
				<div class="form-group col-lg-12">
				<p class="alert alert-warning">
					<strong>Justificación de descartes: </strong>${oferta.justificacion}</p>
					<h2>
						<strong>Actualizar oferta</strong>
					</h2>
				</div>
				...
				<div class="form-group col-lg-12">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" id="tituloId"
							name="titulo" value="${oferta.titulo}">
					</div>
				</div>
				...
				<div class="form-group col-lg-12">
					...
					<div class="input-group">
						...
						<textarea class="form-control" id="detallesId"
							name="detalles">${oferta.detalles}</textarea>
					</div>
				</div>
				...
				<div class="form-group col-md-6  col-lg-6">
					...
					<div class="input-group">
						...
						<input type="date" class="form-control" id="fechaInicioId"
							name="fechaInicio" value="${oferta.fechaInicio}">
					</div>
				</div>
				...
				<div class="form-group col-md-6  col-lg-6">
					...
					<div class="input-group">
						...
						<input type="date" class="form-control" id="fechaFinalId"
							name="fechaFinal" value="${oferta.fechaFinal}">
					</div>
				</div>
				...
				<div class="form-group col-md-4  col-lg-3">
					...
					<div class="input-group">
						...
						<input type="number" class="form-control" id="precioId"
							name="precio" min="0" step="0.01" value="${oferta.precio}">
					</div>
				</div>
				...
				<div class="form-group col-md-4  col-lg-3">
					...
					<div class="input-group">
						...
						<input type="number" class="form-control" id="cuponesId"
							name="cupones" min="0" step="1" value="${oferta.cuponesDisponibles}">
					</div>
				</div>
				...
				<div class="form-group col-md-4  col-lg-6">
					...
					<div class="input-group">
						...
						<input type="date" class="form-control" id="fechaVencimientoId"
							name="fechaVencimiento" value="${oferta.fechaFinalCupon}">
					</div>
				</div>
