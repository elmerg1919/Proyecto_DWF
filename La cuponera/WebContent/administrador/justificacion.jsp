...
<body>
	...
	<div class="container col-xs-10 col-sm-8 col-md-6">
		<div class="row">
			...
			<form action="${contextPath}/administrador.do?op=descartar&id=<%=request.getParameter("id")%>" method="POST">
				<input type="hidden" name="op" value="">
				<div class="form-group col-lg-12">
					<h2>
						<strong>¿Por qué se rechaza la oferta?</strong>
					</h2>
				</div>
				
				<div class="form-group col-lg-12">
					<label for="justificacionId">Justificación:</label>
					<div class="input-group">
						<div class="input-group-addon">
							<i class="fas fa-comment-slash"></i>
						</div>
						<textarea class="form-control" id="justificacionId"
