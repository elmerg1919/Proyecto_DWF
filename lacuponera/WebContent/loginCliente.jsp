			...
			<c:if test="${not empty listaErrores}">
				...
				<form action="${contextPath}/cliente.do" method="POST">
					...
					<div class="form-group col-lg-12">
						<h2>
							<strong><i class="fas fa-users"></i> Iniciar sesión</strong>
						</h2>
					</div>
					...
					<div class="form-group col-lg-12">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="correoId"
								name="correo" placeholder="Ingrese aqui alv">
						</div>
					</div>
					...
					<div class="form-group col-lg-12">
						...
						<small class="help-block">¿Olvidaste tu contraseña? <a href="passCliente.jsp">Ingresa aquí</a></small>
					</div>
					...
					<div class="form-group col-lg-12">
						<div class="input-group">
							...
							</button>  ¿No tienes una cuenta? <a href="registroClientes.jsp">Regístrate aquí</a>
						</div>
					</div>
				</form>
