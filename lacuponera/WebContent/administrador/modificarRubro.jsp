	...
	<div class="container col-xs-10 col-sm-8 col-md-6">
		<div class="row">
			...
			<form action="${contextPath}/administrador.do" method="POST">
				<input type="hidden" name="op" value="modificarr">
				<div class="form-group col-lg-12">
					<h2>
						<strong>Modificar rubro</strong>
					</h2>
				</div>
				
				<input type="hidden" readonly class="form-control" id="codigoId"
							name="codigo" value="${rubro.codigo}">
				<div class="form-group col-lg-12">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" id="nombreId"
							name="nombre" value="${rubro.nombre}">
					</div>
				</div>
				<div class="form-group col-lg-12">
					...
					<div class="input-group">
						...
						<textarea class="form-control" id="descripcionId"
							name="descripcion">${rubro.descripcion}</textarea>
					</div>
				</div>
				<div class="form-group col-lg-12">
